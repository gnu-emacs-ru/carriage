...
- Stability: stable
- Pack-Priority: P2
- Limits/caps/timeouts for the Hub are defined ONLY by Swarm FREEZE (spec/swarm-v1.org#INV).
  ...
  - FREEZE names referenced by this spec: bind, proxy-max-upstream, proxy-connect-timeout-sec, proxy-read-timeout-sec.
