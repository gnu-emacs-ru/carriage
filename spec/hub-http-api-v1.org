...
- Stability: stable
- Pack-Priority: P2
- All limits and behaviors in this section MUST match the Swarm FREEZE values defined in spec/swarm-v1.org (single source of truth).
- Specs/docs MUST reference Swarm FREEZE *names* and MUST NOT restate the numeric values anywhere outside spec/swarm-v1.org.
