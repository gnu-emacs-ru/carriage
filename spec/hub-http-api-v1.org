...
- Stability: stable
- Pack-Priority: P2
- All numeric limits and behaviors in this section MUST match the Swarm FREEZE values in spec/swarm-v1.org (single source of truth).
- Implementations and other specs MUST reference the Swarm FREEZE *names*; duplicating numeric literals outside spec/swarm-v1.org is forbidden.
