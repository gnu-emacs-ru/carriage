...
- All limits/caps/timeouts in this section MUST match the Swarm FREEZE values defined in spec/swarm-v1.org (single source of truth).
  ...
  - Required FREEZE names referenced by this spec: bind, proxy-max-upstream, proxy-connect-timeout-sec, proxy-read-timeout-sec.
...
- Hub proxy is non-blocking; timeouts, caps, and bounded buffering are enforced:
  ...
  - Proxy SSE MUST NOT accumulate unbounded data; forwarding MUST be chunk-by-chunk; slow clients MUST be disconnected.
