...
- Any discovery/limits-related numeric constants MUST be defined only via Swarm FREEZE in spec/swarm-v1.org; duplicating numeric literals elsewhere is forbidden.
