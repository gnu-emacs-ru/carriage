...
- Any discovery/limits-related numeric constants MUST be defined only via Swarm FREEZE in spec/swarm-v1.org (single source of truth).
- Specs/docs MUST NOT duplicate numeric literals outside spec/swarm-v1.org; implementations SHOULD centralize these values in code and MUST remain consistent with Swarm FREEZE.
