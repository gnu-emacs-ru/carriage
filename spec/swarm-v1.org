...
- Stability: stable
- Pack-Priority: P1
- FREEZE values in this section are the single source of truth for Swarm; all other specs/docs MUST reference these FREEZE *names* and MUST NOT duplicate or redefine the numeric values elsewhere.
