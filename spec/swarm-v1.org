...
- REQ-swarm-010: Errors MUST map to errors-v2 with structured envelopes; severity preserved.
...
- Stability: stable
- Pack-Priority: P1
- CHK-swarm-001: Agent health OK on loopback; token enforced
- CHK-swarm-002: SSE emits ui/apply/report/transport/heartbeat; reconnects tolerated
- CHK-swarm-003: Hub lists agents from Registry; stale entries cleaned
- CHK-swarm-004: Hub proxies Agent API/stream; browser never sees tokens
- CHK-swarm-005: Whitelist commands enforced; unknown → WEB_E_CMD
- CHK-swarm-006: Payload caps respected; truncation metrics exposed
