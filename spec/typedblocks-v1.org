...
- task, notes, analysis, plan, verify, commands, context, state_manifest, patch, question, answer.

Inclusion matrix (defaults)
- Included: task, analysis, plan, verify, context, state_manifest, question, answer.
...
- LLM Output Contract (Typed Blocks v1):
  • Allowed types: task, analysis, plan, verify, commands, context, state_manifest, question, answer, notes.
